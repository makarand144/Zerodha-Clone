       ...
       <div className='container p-3'>
            <div className='row'>
                <div className='col-6 p-5'>
                    ...
                    <p className='text-muted'>That's why 1.3+ crore customers trust Zerodha with 3.5+ lakh crores worth of
                        equity investments.
                    </p>

                    <h2 className='fs-4'>No spam or gimmicks</h2>
                    <p className='text-muted'>No gimmicks, spam, "gamification" or annoying push notifications. High quality
                    ...
                    <p className='text-muted'>With initiatives like Nudge and Kill Swtich, we don't just facilitate transactions,
